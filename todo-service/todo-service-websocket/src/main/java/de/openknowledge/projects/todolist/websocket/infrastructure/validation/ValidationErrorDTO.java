 ...
 */
package de.openknowledge.projects.todolist.websocket.infrastructure.validation;

import static org.apache.commons.lang3.Validate.notNull;

import de.openknowledge.projects.todolist.websocket.infrastructure.error.ApplicationError;
...
public class ValidationErrorDTO extends ApplicationErrorDTO {
  ...
  public ValidationErrorDTO(final ConstraintViolation constraintViolation) {
    super(extractErrorCode(notNull(constraintViolation, "must not be null")),
          extractErrorMessage(notNull(constraintViolation, "must not be null")));
  }

  private static ApplicationError extractErrorCode(final ConstraintViolation constraintViolation) {
