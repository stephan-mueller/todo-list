...
import de.openknowledge.projects.todolist.websocket.infrastructure.domain.builder.DefaultBuilder;
import de.openknowledge.projects.todolist.websocket.infrastructure.domain.entity.AbstractEntity;
...
/**
 * An entity that represents a todo.
 */
@Entity
@Table(name = "TAB_TODO")
