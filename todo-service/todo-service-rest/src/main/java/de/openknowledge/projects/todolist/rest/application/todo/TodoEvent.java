...
import static de.openknowledge.projects.todolist.rest.application.todo.TodoEvent.ChangeType.CREATED;
import static de.openknowledge.projects.todolist.rest.application.todo.TodoEvent.ChangeType.DELETED;
import static de.openknowledge.projects.todolist.rest.application.todo.TodoEvent.ChangeType.UPDATED;

import de.openknowledge.projects.todolist.rest.domain.todo.Todo;

import java.time.LocalDateTime;

public class TodoEvent extends TodoListDTO {
