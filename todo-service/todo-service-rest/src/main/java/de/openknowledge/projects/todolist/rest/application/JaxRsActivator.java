 ...
 */
package de.openknowledge.projects.todolist.rest.application;
...
@Info(title = "Todo API", description = "Provides access to the API showcase operations", version = "1.0.0",
